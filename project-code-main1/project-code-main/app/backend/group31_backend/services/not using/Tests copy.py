...
def getPlayersByTeamId(team_id: str):
    ...
    for result in results["results"]["bindings"]:
        ...
        DOB= getPlayerDateOfBirth(player_id)
        citizenship = getPlayerCountryOfCitizenship(player_id)
        position = getPlayerPositionSpecialty(player_id)
        birthName = getPlayerBirthName(player_id)
